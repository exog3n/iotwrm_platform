...
class Actuator extends Device {
  ...
  static async load (id) {
    ...
    return new Actuator(id, title, specification_id, role, mc_id, io, state, latest_report_id);
  }
  ...
  static async generate (params, specification) {
    ...
    return new Actuator(id, title, specification || specification_id, role, mc_id, io, state, latest_report_id);
  }
